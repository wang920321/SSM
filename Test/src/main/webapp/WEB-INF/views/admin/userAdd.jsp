        ...
        <form id="userAddForm" method="post">
            <table class="grid">
                <tr>
                    ...
                    <td>姓名</td>
                    <td><input name="name" type="text" validtype="chinese" placeholder="请输入姓名" class="easyui-validatebox" data-options="required:true,novalidate:true" value=""></td>
                </tr>
                <tr>
                    <td>密码</td>
                ...
                <tr>
                    <td>年龄</td>
                    <td><input type="text" name="age" validtype="age"  class="easyui-numberbox,novalidate:true"/></td>
                    <td>用户类型</td>
                    <td>
                ...
                <tr>
                    <td>电话</td>
                    <td>
                        <input type="text" name="phone" validtype="mobile"  class="easyui-numberbox,novalidate:true"/>
                    </td>
                    <td>角色</td>

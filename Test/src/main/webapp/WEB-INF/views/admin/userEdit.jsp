        ...
        <form id="userEditForm" method="post">
            ...
            <table class="grid">
                <tr>
                    ...
                    <td>姓名</td>
                    <td><input name="name" type="text" validtype="chinese" placeholder="请输入姓名" class="easyui-validatebox" data-options="required:true" value="${user.name}"></td>
                </tr>
                <tr>
                    <!-- <td>密码</td>
                    ...
                    <td>电话</td>
                    <td>
                        <input type="text" name="phone" validtype="mobile"  class="easyui-numberbox" value="${user.phone}"/>
                    </td>
                </tr>
                <tr>
                    <td>年龄</td>
                    <td><input type="text" name="age" validtype="age" value="${user.age}" class="easyui-numberbox"/></td>
                    <td>用户类型</td>

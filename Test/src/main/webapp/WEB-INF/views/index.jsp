...
<body>
    ...
    <div id="index_layout" style="background:red;">
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2017 技术支持 <a href="#" target="_blank">liugen</a></div>
    </div>

...
import com.yb2g.ssm.controller.validation.ValidGroup1;
import com.yb2g.ssm.po.ItemsCustom;
import com.yb2g.ssm.po.ItemsQueryVo;
import com.yb2g.ssm.service.ItemsService;
...
public class ItemsController {
	...
	/**
	 * 全查询 @Title: queryItems @Description: @return ModelAndView @throws
	 */
	...
	@RequestMapping(value = "/editItems", method = { RequestMethod.GET })
	@RequiresPermissions("item:update")//执行editItems需要"item:update"权限
